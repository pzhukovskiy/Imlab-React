...
import ShowHistory from "./HistoryResults";
...
function Calculator() {
    ...
    const addCalculate = (e) => {
        ...
        switch(e.code) {
            ...
            case "Backspace": {
                action ? setNum1(num1.substring(0, num1.length - 1)) : setNum2(num2.substring(0, num2.length - 1));
                break;
        ...
        <div className="Calculator">
            <div className="container">
                <div className="box child_1">
                    Введите 1-ое число
                    <button id="button1" onClick={() => addAction(true)}>Ввести 1-ое число</button>
                </div>
                <div className="box child_2">
                    Введите 2-ое число
                    <button id="button2" onClick={() => addAction(false)}>Ввести 2-ое число</button>
                </div>
                ...
                <div className="box child_4">
                    ...
                    <button onClick={() => CalculateNumbers(num1, num2, '*')}>Умножение</button>
                    <button onClick={() => CalculateNumbers(num1, num2, '/')}>Деление</button>
                    <button id="btnShow">Записать результат</button>
                    </div>
                </div>
                <div className="box child_5">
                    Кнопка очистки
                    <button id="clearShow" onClick={() => console.log("Clear")}>Очистить историю</button>
                </div>
            </div>
        </div>
    )
